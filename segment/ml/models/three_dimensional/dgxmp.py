...
class ModelParallelUNet3D(nn.Module):
    ...
    def __init__(self, n_channels, n_classes):
        super(ModelParallelUNet3D, self).__init__()
        ...
        self.up1 = Up(16, 8).to('cuda:2')
        self.up2 = Up(8, 4).to('cuda:2')
        self.up3 = Up(4, 2).to('cuda:3')
        self.outconv = OutConv(2, n_classes).to('cuda:3')
    ...
    def forward(self, x):
        ...
        # Transfer to next GPU:2 & idx2, idx3 -> GPU:2
        x4  = x4.to('cuda:2') 
        indices2, indices3 = indices2.to('cuda:2'), indices3.to('cuda:2')
        # GPU 2
